...
namespace HospitalApp.Employee
{
    public partial class EmployeeHomePage : Form
    {
        ...
        private void gridBooking_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            else if (value.ToLower().Equals("finished/tested") == true)
            {
                gridBooking.Rows[e.RowIndex].DefaultCellStyle.BackColor = Color.DarkOrange;
                dataGridViewCellStyle.Padding = new Padding(0, 0, 1000, 0);
                cancelButtonRow.Style = dataGridViewCellStyle;
                cancelButtonRow.ReadOnly = true;
                changeScgeduleButtonRow.Style = dataGridViewCellStyle;
        ...
        //            cmd.CommandType = CommandType.Text;
        //            cmd.CommandText = "select duration from tb_empScheduleList where Id=@rowid ";
        ...
        //            cmd2.CommandType = CommandType.Text;
        //            cmd2.CommandText = " select * from tb_empScheduleList ";
        //            cmd2.ExecuteNonQuery();
        ...
        //            {
        //                DateTime sTime = Convert.ToDateTime(dr[3]);
        //                DateTime eTime = Convert.ToDateTime(dr[4]);
        //                string getStatus = dr[6].ToString();
        //                cmd2.Parameters.Clear();
        //                if(getStatus == "Booked")
        //                cmd2.CommandText = "update tb_empScheduleList set startingTime=@startingTime,endingTime=@endingTime where Id =@rowId)";
        //                cmd2.Parameters.AddWithValue("startingTime", sTime.AddHours(dt1));
        //                cmd2.Parameters.AddWithValue("startingTime", sTime.AddHours(dt1));
        //                cmd2.Parameters.AddWithValue("rowId", rowId+1);
        //                cmd2.ExecuteNonQuery();
        //            }
